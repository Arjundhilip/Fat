'use client'
import { top, intro, reviews, ingredient_pic, list, time, prep, notes, rcintro, ingredients, info, diet } from '@/constants/dishes/mutton_chukka_varuval'
...
export default Mutton_chukka_varuval
