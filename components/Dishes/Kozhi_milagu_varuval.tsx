'use client'
import { top, intro, reviews, ingredient_pic, list, time, prep, notes, rcintro, ingredients, info, diet } from '@/constants/dishes/kozhi_milagu_varuval'
...
export default Kozhi_milagu_varuval
