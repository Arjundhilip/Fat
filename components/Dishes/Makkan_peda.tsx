'use client'
import { top, intro, reviews, ingredient_pic, list, time, prep, notes, rcintro, ingredients, info, diet } from '@/constants/dishes/makkan_peda'
