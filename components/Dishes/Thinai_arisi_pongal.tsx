'use client'
import { top, intro, reviews, ingredient_pic, list, time, prep, notes, rcintro, ingredients, info, diet } from '@/constants/dishes/thinai_arisi_pongal'
...
export default Thinai_arisi_pongal
