'use client'
import { cooking, intro, reviews } from '@/constants/dishes/popular/ahani_mutton_vellai_biriyani'
...
const Ahani_mutton_vellai_biriyani = () => {
...
export default Ahani_mutton_vellai_biriyani
