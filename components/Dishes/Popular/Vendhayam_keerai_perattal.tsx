'use client'
import { cooking, intro, reviews } from '@/constants/dishes/popular/vendhayam_keerai_perattal'
...
const Vendhayam_keerai_perattal = () => {
...
export default Vendhayam_keerai_perattal
