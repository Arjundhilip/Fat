'use client'
import { cooking, intro, reviews } from '@/constants/dishes/popular/avicha_maravalli_kilangu'
...
const Avicha_maravalli_kilangu = () => {
...
export default Avicha_maravalli_kilangu
