'use client'
import { cooking, intro, reviews } from '@/constants/dishes/popular/dindigul_chicken_biryani'
...
const Dindigul_chicken_biryani = () => {
...
export default Dindigul_chicken_biryani
