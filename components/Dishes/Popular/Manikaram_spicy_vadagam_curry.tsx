'use client'
import { cooking, intro, reviews } from '@/constants/dishes/popular/manikaram_spicy_vadagam_curry'
...
const Manikaram_spicy_vadagam_curry = () => {
...
export default Manikaram_spicy_vadagam_curry
