'use client'
import { cooking, intro, reviews } from '@/constants/dishes/popular/kanyakumari_coconut_rice'
...
const Kanyakumari_coconut_rice = () => {
...
export default Kanyakumari_coconut_rice
