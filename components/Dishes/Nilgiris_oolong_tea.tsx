'use client'
import { top, intro, reviews, ingredient_pic, list, time, prep, notes, rcintro, ingredients, info, diet } from '@/constants/dishes/nilgiris_oolong_tea'
...
export default Nilgiris_oolong_tea
