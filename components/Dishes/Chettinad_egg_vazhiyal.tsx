'use client'
import { top, intro, reviews, ingredient_pic, list, time, prep, notes, rcintro, ingredients, info, diet } from '@/constants/dishes/chettinad_egg_vazhiyal'
...
export default Chettinad_egg_vazhiyal
